...
from flask import Flask, render_template, url_for, request, session, flash, make_response
...
def comparer():
	...
	if request.method == 'POST':
		...
		final_time = end-start
	return render_template('compare_summary.html',count = session['value'], ctext=rawtext, final_summary_spacy=final_summary_spacy, final_summary_nltk=final_summary_nltk, final_time=final_time, final_reading_time=final_reading_time, summary_reading_time=summary_reading_time, summary_reading_time_nltk=summary_reading_time_nltk, final_summary_sumy=final_summary_sumy, summary_reading_time_sumy=summary_reading_time_sumy)
